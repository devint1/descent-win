...
char * key_text[256] = {
	"", "", "", "", "", "", "", "", "BKSP", "TAB",							// 0
	"", "", "", "", "", "", "SHIFT", "CTRL", "ALT", "PAUSE",				// 10
	"CAPSL", "", "", "", "", "", "", "ESC", "", "",							// 20
	"", "", "SPACE", "PGUP", "PGDN", "END", "HOME", "LEFT", "UP", "RIGHT",	// 30
	"DOWN", "", "", "", "PTSCR", "INS", "DEL", "", "1", "2",				// 40
	"3", "4", "5", "6", "7", "8", "9", "0", "", "",							// 50
	"", "", "", "", "", "A", "B", "C", "D", "E",							// 60
	"F", "G", "H", "I", "J", "K", "L", "M", "N", "O",						// 70
	"P", "Q", "R", "S", "T", "U", "V", "W", "X", "Y",						// 80
	"Z", "OS", "", "MENU", "", "PAD0", "PAD1", "PAD2", "PAD3", "PAD4",		// 90
	"PAD5", "PAD6", "PAD7", "PAD8", "PAD9", "", "PAD*", "PAD+", "", "PAD-",	// 100
	"PAD.", "PAD/", "F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8",			// 110
	"F9", "F10", "F11", "F12", "", "", "", "", "", "",						// 120
	"", "", "", "", "", "", "", "", "", "",									// 130
	"", "", "", "", "NLOCK", "SLOCK", "", "", "", "",						// 140
	"", "", "", "", "", "", "", "", "", "",									// 150
	"LSHFT", "RSHFT", "LCTRL", "RCTRL", "LALT", "RALT", "", "", "", "",		// 160
	"", "", "", "", "", "", "", "", "", "",									// 170
	"", "", "", "", "", "", "", "-", ",", "=",								// 180
	".", "/", "`", "", "", "", ";", "", "", "",								// 190
	"", "", "", "", "", "", "", "", "", "",									// 200
...
ubyte default_kconfig_settings[CONTROL_MAX_TYPES][MAX_CONTROLS] = {
	{ 0x26,0xff,0x28,0xff,0x25,0xff,0x27,0xff,0xff,0xff,0x41,0xff,0x44,0xff,0x51,0xff,0x5a,0xff,0xff,0xff,0x45,0xff,0x43,0xff,0xa2,0xa3,0x20,0xff,0x46,0xff,0x57,0xff,0x53,0xff,0x42,0xff,0x52,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0x9,0xff,0xff,0xff,0xff,0xff },
	...
	if ( !slide_on )	{
		...
		if ( (use_mouse)&&(kc_mouse[13].value < 255) )	{
			if ( !kc_mouse[14].value )		// If not inverted...
				Controls.pitch_time -= (mouse_axis[kc_mouse[13].value]*Config_joystick_sensitivity);
			else
				Controls.pitch_time += (mouse_axis[kc_mouse[13].value]*Config_joystick_sensitivity);
		}
	} else {
	...
	if (!slide_on && !bank_on)	{
		...
		if ( (use_mouse)&&(kc_mouse[15].value < 255 ))	{
			if ( !kc_mouse[16].value )		// If not inverted...
				Controls.heading_time += (mouse_axis[kc_mouse[15].value]*Config_joystick_sensitivity);
			else
				Controls.heading_time -= (mouse_axis[kc_mouse[15].value]*Config_joystick_sensitivity);
		}
	} else {
